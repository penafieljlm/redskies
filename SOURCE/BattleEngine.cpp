...
//                }
            ...
            if(playerIsRed && ((MainClass*)(main))->sound) {
...
void BattleEngine::createCombatEffect(int xCoord, bool isGnd, QWidget* widget) {
    ...
    if(isGnd) {
        ...
        x = x - sprite->value(0)->width();
        e = new Effect(QRect(x,widget->height() - sprite->value(0)->height() * 2,sprite->value(0)->width() * 2,sprite->value(0)->height() * 2),sprite,120,false,widget,this);
        e->alignToGround();
    }
    else {
        ...
        x = x - sprite->value(0)->width();
        int y = 25;
        e = new Effect(QRect(x,y,sprite->value(0)->width() * 2,sprite->value(0)->height() * 2),sprite,120,false,widget,this);
        e->alignToAir();
    }
    e->playAnimation();
    effectList->append(e);
